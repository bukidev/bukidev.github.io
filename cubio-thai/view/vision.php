...
<html lang="th">
    <head>
        ...
        <link rel="stylesheet" href="../assets/css/content-vision.css"> 
    ...
    <body style="overflow-x:hidden; overflow-y:auto;font-family:nanumgothic !important;">
        ...
        <div>
            ...
            <div id="wrapper_main" style="background: url(http://admin.acus.kr) no-repeat;background-position: 50% 0%;; background-size: px  px">
                ...
                <div id="content">
                    <div class="content">
                        ...
                        <div class="right_content" style="">
                            <div class="nav">
                                <p>	
                                    <img src="../assets/img/greeting/icon_home.png"> หน้าหลัก &gt; เกี่ยวกับเรา &gt; วิสัยทัศน์			
                                </p>
                            </div>
                            
                            <div id="grid_area" style="height:200px; ">
                                    ...
                                    <div class="dragEleDiv" style="z-index: 999999;">
                                        <div class="makeContent0" style="z-index: 1;">
                                            <div id="con">
                                                ...
                                                <div class="con_box">
                                                    <ul>
                                                        <li>บริษัทผู้รับผิดชอบ<br>
                                                            ความสุขและสุขภาพของมนุษยชาติ<br>
                                                            ด้วยการตรวจวินิจฉัยมะเร็งในระยะต้น
                                                        </li>
                                                        <li>ทำให้ใครๆก็สามารถตรวจมะเร็ง<br>
                                                            ได้ทุกที่ทุกเวลา<br>
                                                            ด้วยชุดตรวจมะเร็งที่ใช้ง่าย
                                                        </li>
                                                        <li>ก้าวเป็นบริษัทระดับโลก<br>ที่มีเครือข่ายไปทั่วโลก</li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                ...
                <!-- /////////////////////////// footer /////////////////////////// -->
                <div id="footer" style="background-color:#252525;clear:both;position: absolute;bottom: -150px;">
                    <div class="footer">
                        <h1></h1>
                        <div id="footer_area">
                            <!--footer-->
