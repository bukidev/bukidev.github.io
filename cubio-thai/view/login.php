...
<!--	 <div class="gnb_ab" style="border-bottom:2px solid #bbbbbb; z-index:99;">--> <!-- 메뉴 ON 되었을때 선색 -->
...
<div id="login_form">
	...
	<div class="table_login" style="width:100%; height:238px; border:1px solid #e0e0e0; border-top:2px solid #282828; ">
		<form name="login_form" class="flogin" action="http://cubebio.asia/controller/login_check.php" method="post">
			<input type="hidden" name="url" value="http://en.cubebio.co.kr">
			<aside id="login_info" style="float:left; margin:30px 0 100px 0; padding-right:30px; width:130px;">
				<p>
					...
					<span style="font-size: 15px; color:#404040;">Member Login<br>Information</span>
				</p>
			</aside>
			<div style="padding:10px; height: 117px;">
				<ul style="float:left; width:352px; margin-left: 20px;">
					...
					<li>
						<input type="password" name="login_password" id="login_pw" placeholder="Password" required="" class="frm_input required" style="height:45px; width:335px; padding:0 0 0 10px;" size="30" maxlength="20">
					</li>
				</ul>
				<span>
					<input type="image" src="../assets/img/btn_login_en.jpg" onclick="submit" style="padding:0;">
		...
		<div style="float:left;">
			...
			<p style="margin-right:5px;">
				<a href="http://en.cubebio.co.kr/bbs/password_lost.php" target="">
					<button style="font-size: 13px; color: #404040; border:1px solid #e0e0e0; width:100px; line-height:30px; background:#fff; font-family:noto sans CJK KR;">Find ID</button>
				</a>
			</p>
			<p>
				<a href="http://en.cubebio.co.kr/bbs/password_lost.php" target="">
					<button style="font-size: 13px; color: #404040; border:1px solid #e0e0e0; width:100px; line-height:30px; background:#fff; font-family:noto sans CJK KR;">Find Password</button>
				</a>
			</p>
	    </div>
		<div style="float:right;">
			<p>
				<span style="margin-right:20px;">Not yet a member?</span>
				<a href="http://en.cubebio.co.kr/bbs/register.php">
					<button style="font-size: 13px; color: #404040; border:1px solid #e0e0e0; width:100px; line-height:30px; background:#fff; font-family:noto sans CJK KR;">Join</button>
				</a>
			</p>
		</div>
	</div>
