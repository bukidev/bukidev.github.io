...
/*.canvas_grid{ margin-top: -60px; border-top: 2px solid  #06377a; padding-top:50px;}*/
                                ...
                                <div id="con">
                                    <p class="tit">สอบถามเกี่ยวกับ IR</p>

                                    <div class="h1">
                                        <p>พื้นที่สำหรับสอบถามเกี่ยวกับ IR</p>
                                        การตอบคำถามอาจล่าช้าได้ตามรายละเอียดของคำถามที่ท่านถามเข้ามา หรืออาจไม่ได้รับคำตอบหากเกิดสถานการณ์ที่ไม่คาดคิดขึ้น เช่น มีคำถามเข้ามามากเกินไป 
                                        กรุณาอ่านประกาศของบริษัทหรือข้อมูลจากองค์กรผู้ลงทุนก่อน และหากมีข้อสงสัยเพิ่มเติมเกี่ยวกับ CUBEBIO สามารถเขียนคำถามที่ด้านล่างแล้วส่งเข้ามาได้
                                        <p style="font-size:14px; margin:10px 0 30px !important;">* แจ้งให้ทราบว่าข้อความโฆษณาหรือหยาบคายนั้นอาจถูกทำโทษได้ *</p>
                                    </div>	
                                </div>
