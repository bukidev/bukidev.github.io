...
if (!$_SESSION["USER_ID"]){  //check session
	  ...
	  Header("Location: http://cubebio.asia/view/login.php"); //ไม่พบผู้ใช้กระโดดกลับไปหน้า login form 
                    ...
                    <div class="header_top" style="border-bottom:1px solid #e1e1e1;">
                        <div style="width:1200px; margin:0 auto;height:32px">
                            ...
                            <ul class="top_gnb">
                                ...
                                <li><a href="http://cubebio.asia/view/edit_info.php" style="color:#000000; margin-right:10px;">แก้ไขข้อมูล</a></li>
                                <li><a href="http://cubebio.asia/controller/logout.php" style="color:#000000; margin-right:10px;">ออกจากระบบ</a></li>
                                <li style="margin-right:10px;">
                                    <a href="http://cubebio.asia/view/sitemap.html" style="color:#000;">แผนผังเว็บไซต์</a>
                                </li>
                                <li style="margin-right:10px;"><a href="http://cubebio.asia/view/contact.html" style="color:#000000;">ติดต่อเรา</a></li>
                                <li>
                                    <script>
                                    function version(v){
                                        if(v == "KO"){
